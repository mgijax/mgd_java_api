...
@Table(name="all_variant_effect")
public class VariantEffect extends BaseEntity {

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="all_varianteffect_generator")
	@SequenceGenerator(name="all_varianteffect_generator", sequenceName="all_varianteffect_seq", allocationSize=1)
	@ApiModelProperty(value="primary key")
	private int _varianteffect_key;
