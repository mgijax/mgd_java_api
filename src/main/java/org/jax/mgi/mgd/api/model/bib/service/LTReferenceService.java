...
//	private AccessionService accessionService;
	...
	public LTReferenceDomain updateReference(LTReferenceDomain domain, User user) throws FatalAPIException, NonFatalAPIException, APIException {
		...
		query.getResultList();
		return get(Integer.valueOf(domain.refsKey));
	}
	 ...
	 */
	public void applyChanges(LTReference entity, LTReferenceDomain domain, User user) throws NonFatalAPIException, APIException {
