...
public class SlimReferenceByMarkerTranslator extends BaseEntityDomainTranslator<Reference, SlimReferenceByMarkerDomain> {

	private AccessionTranslator accessionTranslator = new AccessionTranslator();
	
	@Override
	protected SlimReferenceByMarkerDomain entityToDomain(Reference entity) {
