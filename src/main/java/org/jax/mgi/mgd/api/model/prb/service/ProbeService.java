...
public class ProbeService extends BaseService<ProbeDomain> {
	...
	public String getProbeBySQL(String queryType, String accid, int offset, int limit, boolean returnCount) {
		...
		+ "\n    left outer join prb_probe pp on p.derivedfrom = pp._probe_key  "
		+ "\n    left outer join acc_accession ppa on p.derivedfrom = ppa._object_key  "
		+ "\n            and ppa._mgitype_key = 3 and ppa._logicaldb_key = 1 and ppa.preferred = 1, "
		+ "\n  voc_term pt,  "
		+ "\n  prb_source ps, "
		+ "\n  mgi_organism o, "
		+ "\n  acc_accession pa "
