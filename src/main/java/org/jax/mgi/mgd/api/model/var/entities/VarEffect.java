...
@Table(name="var_effect")
public class VarEffect extends BaseEntity {

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="var_effect_generator")
	@SequenceGenerator(name="var_effect_generator", sequenceName = "var_effect_seq", allocationSize=1)
