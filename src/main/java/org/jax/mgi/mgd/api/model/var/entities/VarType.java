...
public class VarType extends BaseEntity {
	...
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="var_type_generator")
	@SequenceGenerator(name="var_type_generator", sequenceName = "var_type_seq", allocationSize=1)
